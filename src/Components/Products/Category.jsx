                            ...
                            <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 hover:scale-105 hover:rotate-1">
                                ...
                                <div className="relative overflow-hidden">
                                    <img
                                        src={product.image}
                                        alt={product.name}
                                        className="w-full h-[300px] sm:h-[400px] object-cover transition-all duration-700 group-hover:scale-115 group-hover:brightness-110 group-hover:saturate-110"
                                        style={{
                                            filter: 'contrast(1.1)'
                                        }}
                                    />
                                ...
                                <div className="p-3 sm:p-6 space-y-3 text-center relative bg-gradient-to-b from-white to-gray-50/50">
                                    ...
                                    <h3 className="heading-text font-bold text-2xl sm:text-4xl text-black transition-all duration-300 group-hover:text-[#FDCB2E] transform group-hover:scale-105 group-hover:-translate-y-1">
                                        {product.name}
                                    </h3>

                                    <Link to={`/products/${product.category}`}>
                                        <button
                                            className="block sm:hidden relative w-full sm:w-auto py-3 sm:py-4 font-bold bg-[var(--brand-color)] tracking-widest text-black hover:text-white overflow-hidden group text-sm sm:text-base rounded-xl sm:rounded-2xl transition-all duration-700 hover:scale-105 hover:shadow-2xl hover:shadow-[var(--brand-color)]/30"
                                        >

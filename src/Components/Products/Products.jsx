...
export default function Products() {
    ...
    const FloatingElement = ({ delay, size, position }) => (
        <div
            className={`absolute ${size} bg-[var(--brand-color)] rounded-full opacity-10 animate-bounce hidden lg:block`}
            style={{
                ...position,
    ...
    const GeometricShape = ({ className, delay, type = 'square' }) => (
        <div
            className={`absolute border-2 border-[var(--brand-color)] opacity-10 ${className} hidden lg:block hover:opacity-20 transition-opacity duration-300`}
            style={{
                ...
                background:
                    type === 'circle'
                        ? 'transparent'
                        : 'linear-gradient(45deg, transparent 49%, rgba(251, 191, 36, 0.1) 50%, transparent 51%)',
            }}
        />
    );
            ...
            <div className="relative py-12 sm:py-16 md:py-20 lg:py-24 overflow-hidden">
                ...
                <div className="text-center relative z-10" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <div className="flex items-center justify-center gap-4 sm:gap-6 mt-6 sm:mt-8 transform translate-y-4" style={{ animationDelay: '800ms' }}>
                        <div className="w-6 h-6 sm:w-8 sm:h-8 border-2 border-[var(--brand-color)] transform rotate-45 animate-spin bg-gradient-to-br from-transparent to-[var(--brand-color)]" style={{ animationDuration: '6s' }} />
                        ...
                        <div className="w-6 h-6 sm:w-8 sm:h-8 border-2 border-[var(--brand-color)] transform rotate-45 animate-spin bg-gradient-to-br from-transparent to-[var(--brand-color)]" style={{ animationDuration: '6s', animationDirection: 'reverse' }} />
                    </div>
                                ...
                                <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 hover:scale-105 hover:rotate-1">
                                    ...
                                    <div className="relative overflow-hidden">
                                        <img
                                            src={product.image}
                                            alt={product.name}
                                            className="w-full h-[300px] sm:h-[350px] object-cover transition-all duration-700 group-hover:scale-115 group-hover:brightness-110 group-hover:saturate-110"
                                            style={{
                                                filter: 'contrast(1.1)',
                                            }}
                                        />
